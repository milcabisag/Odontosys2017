...
public class Caja  implements java.io.Serializable {
    ...
    public Caja(Usuario usuario, MovimientoEmpresa movimientoEmpresa, Movimiento movimiento, String descripcion, Integer entrada, Integer salida, String tipo, Date fecha, String descripMovim) {
       this.usuario = usuario;
       ...
       this.tipo = tipo;
       this.fecha = fecha;
       this.descripMovim = descripMovim;
    }
    ...
    public String getDescripMovim() {
        return this.descripMovim;
    }
    
    public void setDescripMovim(String descripMovim) {
        this.descripMovim = descripMovim;
    }
