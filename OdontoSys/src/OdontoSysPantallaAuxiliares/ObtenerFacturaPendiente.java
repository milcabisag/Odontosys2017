 ...
 * @author user
 */
public class ObtenerFacturaPendiente extends javax.swing.JDialog {

    public static Factura fac = null;

    public ObtenerFacturaPendiente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
      ...
      public void mouseClicked(MouseEvent e){
        ...
        tabla.addColumn("Saldo Pendiente");
            ...
            datos = FacturaControlador.ConsultarFactura(pac.getIdPaciente());
            for (Factura factura : datos){
                ...
                jTableFactura.setValueAt(formateador.format(fila[3]), tabla.getRowCount()-1, 3);
            }
    ...
    private void initComponents() {
        ...
        jLabelSeleccionSaldo = new javax.swing.JLabel();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabelSeleccionNro, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelSeleccionSaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObtenerFacturaPendiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ObtenerFacturaPendiente dialog = new ObtenerFacturaPendiente(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel jLabelSeleccionSaldo;
