...
CREATE TABLE `movimiento_empresa` (
  ...
  `fk_nota_emp` int(11) DEFAULT NULL,
  ...
  KEY `fk_movempnota_idx` (`fk_nota_emp`),
  ...
  CONSTRAINT `fk_movempnota` FOREIGN KEY (`fk_nota_emp`) REFERENCES `nota_credito_empresa` (`idnota_credito_empresa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2017-11-28 20:59:39
